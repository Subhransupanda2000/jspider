...
// // Q2.
// var dem=[1,2,3,4]
// console.log(dem.slice(0,1));//2
// console.log(dem.splice(1,2,"hello"));2,"hello",4
// console.log(dem);
...
// api.pop()
// console.log(api.at(-1));
// console.log(api[3]["id"]=0);
...
api2[0]["address"]["geo"]["skills"]=["java","python"]
console.log(api2);
delete (api2[0]["address"]["geo"]["lat"])
delete (api2[0]["address"]["geo"]["lng"])
console.log(api2);
var x=api2[0].name.split("")
console.log(x);
x=x.reverse()
x=x.join("")
api2[0].name=x
...
var ex=api2[0]["address"]["street"].toUpperCase()
console.log(ex);
api2[0]["address"]["street"]=ex
console.log(api2);
